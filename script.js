...
(function () {
  ...
  let X = maxeeCmz["comment-sys"] || "blogger";
  let K = maxeeCmz["FB-app-ID"] || "";
  let S = maxeeCmz["dimaxeeus-ID"] || "";
  let l = maxeeCmz["max-results"] || 10;
  let P = maxeeCmz["max-intro"] || 7;
  let z = maxeeCmz["max-ticker"] || 7;
  let u = maxeeCmz["max-rel"] || 10;
  let H = maxeeCmz["rdct-time"] || 10;
  let b = maxeeCmz["rdct-exclude"] || "";
  let g = maxeeCmz["auto-redirect"] !== undefined ? maxeeCmz["auto-redirect"] : false;
  let y = maxeeCmz["see-also"] !== undefined ? maxeeCmz["see-also"] : true;
  let c = maxeeCmz["cool-comments"] !== undefined ? maxeeCmz["cool-comments"] : true;
  let T = maxeeCmz["show-related"] !== undefined ? maxeeCmz["related-posts"] : true;
  let I = maxeeCmz["show-nextprev"] !== undefined ? maxeeCmz.nextprev : true;
  let s = maxeeCmz["lazy-load"] !== undefined ? maxeeCmz["lazy-load"] : true;
  let f = maxeeCmz["sticky-nav"] !== undefined ? maxeeCmz["sticky-nav"] : true;
  let o = maxeeCmz["menu-fixed"] !== undefined ? maxeeCmz["menu-fixed"] : false;
  let e = maxeeCmz["topbar-fixed"] !== undefined ? maxeeCmz["topbar-fixed"] : false;
  let C = maxeeCmz["repeat-midad"] !== undefined ? maxeeCmz["repeat-midad"] : false;
  let Z = maxeeCmz["repeat-indexad"] !== undefined ? maxeeCmz["repeat-indexad"] : 0;
  let L = maxeeCmz["support-webp"] !== undefined ? maxeeCmz["support-webp"] : false;
  let d = maxeeCmz["blogger-api"] !== undefined ? maxeeCmz["blogger-api"] : false;
  let G = maxeeCmz["old-blogger"] !== undefined ? maxeeCmz["old-blogger"] : false;
  let x = maxeeCmz["redirect-inside"] !== undefined ? maxeeCmz["redirect-inside"] : false;
  let v = maxeeCmz["redirect-page"];
  let r = maxeeCmz["authors-page"];
