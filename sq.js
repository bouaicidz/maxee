gdata.io.handleScriptLoaded({
  ...
  "entry": {
    ...
    "id": {
      "$t": "tag:blogger.com,1999:blog-7500329921028726766.post-5211675400510419025"
    },
    "published": {
      "$t": "2020-08-31T17:42:00.001-07:00"
    },
    "updated": {
      "$t": "2022-05-03T18:55:11.622-07:00"
    },
    "title": {
      "type": "text",
      "$t": "2.3"
...
(function () {
  ...
  let K = SqCmz["FB-app-ID"] || '';
  let S = SqCmz["disqus-ID"] || '';
  let l = SqCmz["max-results"] || 10;
  let P = SqCmz["max-intro"] || 7;
  let z = SqCmz["max-ticker"] || 7;
  let u = SqCmz["max-rel"] || 10;
  let H = SqCmz["rdct-time"] || 10;
  let b = SqCmz["rdct-exclude"] || '';
  let g = SqCmz["auto-redirect"] !== undefined ? SqCmz["auto-redirect"] : false;
  let y = SqCmz["see-also"] !== undefined ? SqCmz["see-also"] : true;
  let c = SqCmz["cool-comments"] !== undefined ? SqCmz["cool-comments"] : true;
  let T = SqCmz["show-related"] !== undefined ? SqCmz["related-posts"] : true;
  let I = SqCmz["show-nextprev"] !== undefined ? SqCmz.nextprev : true;
  let s = SqCmz["lazy-load"] !== undefined ? SqCmz["lazy-load"] : true;
  let f = SqCmz["sticky-nav"] !== undefined ? SqCmz["sticky-nav"] : true;
  let o = SqCmz["menu-fixed"] !== undefined ? SqCmz["menu-fixed"] : false;
  let e = SqCmz["topbar-fixed"] !== undefined ? SqCmz["topbar-fixed"] : false;
  let C = SqCmz["repeat-midad"] !== undefined ? SqCmz["repeat-midad"] : false;
  let Z = SqCmz["repeat-indexad"] !== undefined ? SqCmz["repeat-indexad"] : 0;
  let L = SqCmz["support-webp"] !== undefined ? SqCmz["support-webp"] : false;
  let d = SqCmz["blogger-api"] !== undefined ? SqCmz["blogger-api"] : false;
  let G = SqCmz["old-blogger"] !== undefined ? SqCmz["old-blogger"] : false;
  let x = SqCmz["redirect-inside"] !== undefined ? SqCmz["redirect-inside"] : false;
  let v = SqCmz["redirect-page"];
  let r = SqCmz["authors-page"];
  ...
  function U7() {
    ...
    Ue.innerHTML = "console.group(\"%cSqueeze Template\", \"font-weight:bold;color:#d24949;font-family:Tahoma;font-size:18px;\");console.log(\"» Homepage      : https://squeeze-template.blogspot.com\");console.log(\"» Designed by   : Ahmad Saleh\");console.log(\"» Programmed by : Muhammad Saleh\");console.log(\"» Version       : 2.3.0\");console.groupEnd()";
  ...
  let UU = setInterval(function () {
    ...
    if (UI.indexOf("https://squeeze-template.blogspot.com") == -1) {
      U9(2);
    }
...
"
    ...
    "link": [{
      ...
      "href": "https://activesquezze230.blogspot.com/feeds/5211675400510419025/comments/default",
      "title": "تعليقات الرسالة"
    }, {
      "rel": "replies",
      "type": "text/html",
      "href": "https://activesquezze230.blogspot.com/2020/08/23_31.html#comment-form",
      "title": "0 تعليقات"
    }, {
      "rel": "edit",
      "type": "application/atom+xml",
      "href": "https://www.blogger.com/feeds/7500329921028726766/posts/default/5211675400510419025"
    }, {
      "rel": "self",
      "type": "application/atom+xml",
      "href": "https://www.blogger.com/feeds/7500329921028726766/posts/default/5211675400510419025"
      ...
      "rel": "alternate",
      "type": "text/html",
      "href": "https://activesquezze230.blogspot.com/2020/08/23_31.html",
      "title": "2.3"
    }],
    "author": [{
      "name": {
      ...
      "gd$image": {
        ...
        "width": "32",
        "height": "32",
        "src": "//blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgplA3LjUyrLVLcHMHA3CZ5IxFyTadkn35o9a5O-FOlOuO_oonK9rLGbQ30kM6ZNaYI4CoNct2_6e5Wavro2x1JYdEZVaRDOXvZ9G6dvlxTahGe8451_1dTLkspm42iZrY/s220/teamplates_king11.ico"
      }
    }],
    "thr$total": {
      "$t": "0"
